...
public class UserController {
    ...
    private static final Integer ENCRYPTION_TIMES = 2;
    /*
    * 登录
    * */
    ...
    public String login(@RequestBody User user, HttpServletRequest request) {
        if (userService.getUser(user) != null) {
            ...
            String encodePassword = new SimpleHash(ENCRYPTION_TYPE, user.getPassword(), encrypt, ENCRYPTION_TIMES).toString();
